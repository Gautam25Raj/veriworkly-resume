// @ts-nocheck
import * as __fd_glob_30 from "../content/docs/user-guides/resume-templates.mdx?collection=docs"
import * as __fd_glob_29 from "../content/docs/user-guides/exporting-and-sharing.mdx?collection=docs"
import * as __fd_glob_28 from "../content/docs/operations/service-status.mdx?collection=docs"
import * as __fd_glob_27 from "../content/docs/operations/environment-variables.mdx?collection=docs"
import * as __fd_glob_26 from "../content/docs/getting-started/quick-start.mdx?collection=docs"
import * as __fd_glob_25 from "../content/docs/getting-started/local-setup.mdx?collection=docs"
import * as __fd_glob_24 from "../content/docs/getting-started/docker-deployment.mdx?collection=docs"
import * as __fd_glob_23 from "../content/docs/architecture/pdf-generation.mdx?collection=docs"
import * as __fd_glob_22 from "../content/docs/architecture/monorepo.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_19, }, {"index.mdx": __fd_glob_20, "overview.mdx": __fd_glob_21, "architecture/monorepo.mdx": __fd_glob_22, "architecture/pdf-generation.mdx": __fd_glob_23, "getting-started/docker-deployment.mdx": __fd_glob_24, "getting-started/local-setup.mdx": __fd_glob_25, "getting-started/quick-start.mdx": __fd_glob_26, "operations/environment-variables.mdx": __fd_glob_27, "operations/service-status.mdx": __fd_glob_28, "user-guides/exporting-and-sharing.mdx": __fd_glob_29, "user-guides/resume-templates.mdx": __fd_glob_30, });