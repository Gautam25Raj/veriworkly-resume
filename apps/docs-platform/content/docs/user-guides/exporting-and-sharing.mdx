...
<Callout type="warn" title="Data Privacy Boundary">
  PDF generation requires the temporary transmission of document payloads to our API. For unauthenticated users, this data is processed exclusively in-memory and is discarded immediately following document delivery.
</Callout>
