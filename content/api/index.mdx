...
<Cards>
  <Card title="Health & Diagnostics" icon={<Activity />} href="/docs/api-reference/health">
    Monitor system uptime, PostgreSQL database connectivity, and Redis queue health.
  </Card>

<Card title="Users Module" icon={<Lock />} href="/docs/api-reference/users">
  Protected operations for authenticated users. Fetch profile metadata and
  manage account configurations.
</Card>

<Card title="Roadmap Tracker" icon={<Map />} href="/docs/api-reference/roadmap">
  Query public roadmap features, filter by development status, and aggregate
  completion statistics.
</Card>

  <Card title="GitHub Integrations" icon={<img width={24} height={24} src="/icons/socials/github.svg" alt="GitHub Icon" className="w-5 h-5" />} href="/docs/api-reference/github">
